...
function huge_it_google_mapss_activate(){
	...
	$sqlInsertMap1 = "INSERT INTO ".$wpdb->prefix."g_maps (name ,info_type , type, zoom, center_lat, center_lng, width, height, align, border_radius) VALUES ('Моя карта' ,'click' , 'ROADMAP', '7', '40.7127837', '-74.00594130000002', '100', '300', 'center', '0')";
