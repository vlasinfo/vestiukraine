...
function wpcf7_admin_menu() {
	...
	$addnew = add_submenu_page( 'wpcf7',
		__( 'Добавить новую форму', 'contact-form-7' ),
		__( 'Добавить', 'contact-form-7' ),
