    ...
    <?php else: ?>
        ...
        <div class="wpml-section" id="lang-sec-0">
            ...
            <div class="wpml-section-content">
                ...
                <p><?php _e('Enter the site key, from your https://wpml.com account, to receive automatic updates for WPML on this site.', 'sitepress'); ?></p>
                <form id="installer_registration_form">
                    <input type="hidden" name="action" value="installer_save_key" />
                    <input type="hidden" name="button_action" value="installer_save_key" />
                    <label>
                ...
                <?php if(empty($site_key)): ?>
                <p><?php printf(__("Don't have a key for this site? %sGenerate a key for this site%s", 'sitepress'), '<a class="button-primary" href="https://wpml.com/my-account/sites/?add='.urlencode(get_site_url()).'" target="_blank">', '</a>') ?></p>
                <p><?php printf(__("If you don't have a https://wpml.com account or a valid subscription, you can %spurchase%s one and get later upgrades, full support and 30 days money-back guarantee." , 'sitepress'), '<a href="http://wpml.org/purchase/" target="_blank">', '</a>') ?></p>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="icl_error_text" style="display:none;margin:10px;">
                                        ...
                                        <a href="https://wpml.com/?page_id=1010"><?php _e('How to fix','sitepress') ?></a>
                                            <p>
                    ...
                    <div class="wpml-section-content">
                        ...
                        <div class="wpml-section-content-inner">
                            ...
                            <p class="icl_advanced_feature"><?php _e('You can also create custom language switchers, such as a list of languages or country flags.','sitepress'); ?>
                                <a href="https://wpml.com/?page_id=989"><?php _e('Custom language switcher creation guide','sitepress')?></a>.
                            </p>
                            <p>
                                <label>
            ...
            <div class="wpml-section-content">
                <form id="icl_promote_form" name="icl_promote_form" action="">
                    ...
                    <p>
                        ...
                        <?php printf(__("Tell the world your site is running multilingual with WPML (places a message in your site's footer) - <a href=\"%s\">read more</a>", 'sitepress'),'https://wpml.com/?page_id=4560'); ?></label>
                    </p>
                    <p class="buttons-wrap">
