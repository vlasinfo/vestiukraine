                            ...
                            if($job_id){
                                ...
                                if($current_user_is_translator){
                                    ...
                                    if($tres->status == ICL_TM_IN_PROGRESS){
                                        ...
                                        $add_anchor =  sprintf(__('In progress (by a different translator). <a%s>Learn more</a>.','sitepress'), ' href="https://wpml.com/?page_id=52218"');
                                    }elseif($tres->status == ICL_TM_NOT_TRANSLATED || $tres->status == ICL_TM_WAITING_FOR_TRANSLATOR){
                                        $img = 'add_translation_disabled.png';
                                        $add_anchor = sprintf(__('You are not the translator of this document. <a%s>Learn more</a>.','sitepress'), ' href="https://wpml.com/?page_id=52218"');
                        ...
                        case ICL_TM_TMETHOD_EDITOR:
                            ...
                            if($needs_update){
                                ...
                                if($current_user_is_translator){
                                    ...
                                    $edit_link = '#';
                                    $img = 'edit_translation_disabled.png';
                                    $edit_anchor = sprintf(__('You are not the translator of this document. <a%s>Learn more</a>.','sitepress'), ' href="https://wpml.com/?page_id=52218"');
                                }
                            }else{
