...
function cpt_default_and_st_language_warning()
{
	...
	if (defined('WPML_ST_FOLDER') && !$called ) {
		...
		$message = sprintf( $message, $st_language, $st_language, 'https://wpml.com/faq/string-translation-default-language-not-english/', $st_page_url );
		...
		$fallback_message = sprintf( $fallback_message, 'https://wpml.com/faq/string-translation-default-language-not-english/' );
