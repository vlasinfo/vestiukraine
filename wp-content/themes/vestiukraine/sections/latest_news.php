		...
		<section class="latest-news" id="latestnews">
			<div class="container">
				...
				<?php
					...
					if( !empty($zerif_latestnews_title) ):
						...
						echo '<h2 class="dark-text">' . __('Vacancies','zerif-lite') . '</h2>';
					endif;
                    ...
                    if( !empty($zerif_latestnews_subtitle) ):
                        ...
                        echo '<h6 class="dark-text">' . __('We are looking for talented teammates all the time! Explore opportunities with Developex!','zerif-lite') . '</h6>';
                    endif;
                ...
                <div id="carousel-homepage-latestnews" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        $zerif_latestnews_cat = apply_filters('zerif_latest_news_cat', '3');
                                ...
                                <div class="col-sm-3 latestnews-box">
                                    ...
                                    <div class="latestnews-img">
                                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                                            ...
                                            <?php else: ?>
                                                <img
                                                    src="<?php echo esc_url(get_template_directory_uri()); ?>/images/blank-latestposts.png">
                                            <?php endif; ?>
                                    ...
                                    <div class="latesnews-content">
                                        ...
                                        <h5 class="latestnews-title"><a href="<?php the_permalink(); ?>"
                    ...
                    <!-- Controls -->
                    <a class="left carousel-control" href="#carousel-homepage-latestnews" role="button"
                       data-slide="prev">
                        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                        <span class="sr-only"><?php _e('Previous', 'zerif-lite'); ?></span>
                    </a>
                    <a class="right carousel-control" href="#carousel-homepage-latestnews" role="button"
                       data-slide="next">
            ...
            <?php
                    ...
                    <h3 class="container text">No vacancies now</h3>
            <?php
                }
               ?>
